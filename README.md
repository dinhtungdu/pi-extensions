...
2. Invite the bot with the `bot` and `applications.commands` scopes plus View Channels, Read Message History, Send Messages, Add Reactions, Create Public Threads, Manage Threads, Manage Channels, and Manage Webhooks permissions. Existing installations must add Manage Webhooks before reconnecting.
