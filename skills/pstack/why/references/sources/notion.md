...
- **Doc vs. reality drift.** A spec may say "we'll do X" but the code actually does Y. Flag the divergence. The parent will surface the contradiction.
...
- Relevant linked pages (so the parent can cite them)
