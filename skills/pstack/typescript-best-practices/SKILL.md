...
Pi does not support the upstream path-scoped skill metadata. Invoke `/skill:typescript-best-practices` explicitly for TypeScript work, or load it from the owning workflow.
