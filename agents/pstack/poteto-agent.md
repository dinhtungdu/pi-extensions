...
When the task permits edits, write only inside its stated checkout or isolated scratch path. Never share a writable checkout with another child. When the task is analysis, review, or synthesis, do not edit files.
